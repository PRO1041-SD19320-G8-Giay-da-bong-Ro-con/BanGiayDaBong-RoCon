 ...
 * @author FPT SHOP
 */
public class SanPham_JDialog extends javax.swing.JDialog {

    private List<SanPham> lstSP = new ArrayList<>();
    DefaultTableModel tblModel = new DefaultTableModel();
    SanPham_Ser ql = new SanPham_Ser();
    int index = -1;

    /**
     * Creates new form SanPhamJDialog
     */
    public SanPham_JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        cboGia.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Hiển thị toàn bộ" }));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cboGia, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(29, 29, 29)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jComboBox10, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(31, 31, 31))
        );

        jPanel5Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {cboGia, jComboBox10, jComboBox2, jComboBox3, jComboBox8});
    ...
    private void cboGiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboGiaActionPerformed
        ...
        SanPham sp = (SanPham) cboGia.getSelectedItem();
        loadTable(ql.getSanPhamTheoGia(String.valueOf(sp.getGia())));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SanPham_JDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SanPham_JDialog dialog = new SanPham_JDialog(new javax.swing.JFrame(), true);
